                ...
                <table class="table table-head-fixed text-nowrap">
                  ...
                  @foreach($surat as $srt)
                    <tr>
                      ...
                      <td>
                        <a href="#" type="button" class="btn btn-success disabled">Download</a>
                      </td>
                      @else
                      <td><span class="tag tag-success">Sent</span></td>
                      <td>
                        <a href="/surat/{{$srt->surat}}" download="{{$srt->surat}}" type="button" class="btn btn-success">Download</a>
                      </td>
                      @endif
                ...
                <table class="table table-head-fixed text-nowrap">
                  ...
                  @foreach($surat as $srt)
                    <tr>
                      ...
                      <td>{{ $srt->suratkeluar->user->name }}</td>
                      <td><span class="tag tag-success">{{ $srt->status }}</span>@if($srt->status=='Denied')<br><p class="text-danger">{{$srt->pesan}}</p>@endif</td>
                      <td>
                        @if($srt->status!='Approved')
                        <a href="valid{{$srt->id}}" type="button" class="btn btn-info">Edit</a>
                        @else
                        <a href="unduh{{$srt->id}}" type="button" class="btn btn-info" target="_BLANK">Download</a>
                        @endif
                      </td>
                    </tr>
                    @endforeach
