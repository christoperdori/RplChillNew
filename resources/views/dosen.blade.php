...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <a href="/dosen/buatsrtdosen"> + Tambah Data Baru</a>
          </div>
        </div>
        ...
        <table class="table table-bordered table-dark">
            ...
            <tr>
            <td>{{ $d->jenis_surat }}</td>
			<td>{{ $d->tgl_pelaksanaan_kegiatan }}</td>
         ...
         <a class="btn btn-primary" href="/dosen/download/{{ $d->nik_dosen }}"role="button">Download</a>
         <a class="btn btn-warning" href="/dosen/edit/{{ $d->nik_dosen }}"role="button">Edit</a>
         <a class="btn btn-danger" href="/dosen/hapus/{{ $d->nik_dosen }}"role="button">Hapus</a>
         <a class="btn btn-success" href="/dosen/arsip/{{ $d->nik_dosen }}"role="button">Arsip</a>
