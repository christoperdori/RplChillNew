...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Surat Dekan</h1>
          </div>
        </div>
        ...
        <br/>
	      <br/>
          @foreach($admin as $a)
        <form action="/admin/update/$a->nik_admin" method="post">
        {{ csrf_field() }}
        @method('PUT')
        <input type="hidden" name="id" value="{{ $a->nik_admin }}"> <br/>
        <div class="form-group">
                <label for="tujuansurat">Tujuan Surat</label>
                <input type="text" class="form-control" name="tujuan_surat" placeholder="Masukkan tujuan surat" value="{{ $a->tujuan_surat }}">
            </div>
            <div class="form-group">
                <label for="tgl">Tanggal pelaksanaan kegiatan</label>
                <input type="date" class="form-control" name="tgl_pelaksanaan_kegiatan" value="{{ $a->tgl_pelaksanaan_kegiatan }}">
            </div>
            <div class="form-group">
                <label for="namamitra">Nama Mitra</label>
                <input type="text" class="form-control" name="nama_mitra" placeholder="Masukkan nama mitra" value="{{ $a->nama_mitra }}">
            </div>
            <div class="form-group">
                <label for="alamatmitra">Alamat Mitra</label>
                <input type="text" class="form-control" name="alamat_mitra" placeholder="Masukkan alamat mitra" value="{{ $a->alamat_mitra }}">
            </div>
            <div class="form-group">
                <label for="keterangan">Keterangan</label>
                <input type="text" class="form-control" name="keterangan"  placeholder="Masukkan keterangan" value="{{ $a->keterangan }}">
            </div>
