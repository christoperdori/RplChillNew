  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/dashadmin/admin" class="nav-link">Buat SK Dekan</a>
      </li>
    </ul>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <a href="/admin/buatsrtadmin"> + Tambah Data Baru</a>
          </div>
        </div>
        ...
        <table class="table table-bordered table-dark">
			...
			<td>{{ $a->tgl_pelaksanaan_kegiatan }}</td>
			<td>{{ $a->nama_mitra }}</td>
			<td>{{ $a->alamat_mitra }}</td>
            <td>{{ $a->keterangan }}</td>
			<td>
			

         <a class="btn btn-primary" href="/admin/download/{{ $a->nik_admin }}"role="button">Download</a>
         <a class="btn btn-warning" href="/admin/edit/{{ $a->nik_admin }}"role="button">Edit</a>
         <a class="btn btn-danger" href="/admin/hapus/{{ $a->nik_admin }}"role="button">Hapus</a>
         <a class="btn btn-success" href="/admin/arsip/{{ $a->nik_admin }}"role="button">Arsip</a>
